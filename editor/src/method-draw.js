...
(function() {
  ...
  function start_websocket() {
     websocket = new WebSocket('ws://192.168.2.102:9000', 'echo-protocol');
     websocket.onopen = function ()  { console.log("socket opened"); };
    ...
    var changeCanvasSize = function(ctl){
      ...
      var Actions = function() {
        ...
        var tool_buttons = [
          ...
          {sel:'#tool_reload', fn: function() { editingsource?saveSourceEditor():clickReload()}, evt: 'mouseup', key: [modKey + 'E', true]},
